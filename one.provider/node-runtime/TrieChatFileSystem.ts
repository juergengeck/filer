...
import type {EasyDirectoryContent, EasyDirectoryEntry} from '@refinio/one.models/lib/fileSystems/utils/EasyFileSystem.js';
import EasyFileSystem from '@refinio/one.models/lib/fileSystems/utils/EasyFileSystem.js';
